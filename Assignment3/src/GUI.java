...
public abstract class GUI {
    ...
    /**
     * is called whenever the articulation search search button is pressed
     * should call the search for all articulation points
     * */
    protected abstract void searchAllArticulationPoints();

    /**
     * is called whenever the Minimum spanning tree button is pressed
     * should call the search for minimum spanning tree
     * */
    protected abstract void searchMST();
    /**
    ...
    private void initialise() {
        ...
        //creates search button for searching all articulation points that when pressed calls to search all
        JButton artAllSearch = new JButton ("All Articulation Points Search");
        artAllSearch.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ev) {
                searchAllArticulationPoints();
                redraw();
            }
        });

        //creates search button for minimum spanning tree that when pressed calls to search for MST
        JButton mstSearchBtn = new JButton ("MST Search");
        mstSearchBtn.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ev) {
                searchMST();
                redraw();
            }
        ...
        controls.add(search);
        controls.add(artAllSearch);	//adding after search box
        controls.add(mstSearchBtn);
